...
const destinations = [
  {
    name: "Canada",
    subtitle: "Your best destination",
...
export default function DashboardPage() {
  ...
  const recentActivity = [
    {
      action: "New scholarship match found",
      time: "2 hours ago",
      type: "match",
    },
    {
      action: "Application submitted to Stanford",
      time: "1 day ago",
      type: "success",
    },
    {
      action: "Document uploaded: Transcript",
      time: "2 days ago",
      type: "info",
    },
    {
      action: "Deadline approaching: Fulbright",
      time: "3 days ago",
      type: "warning",
    },
  ];
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {scholarships.map((scholarship) => (
                <Card
                  key={scholarship.id}
                  className="group hover-lift border-border bg-card"
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Providers 120 world class education in 6 countries
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Partnered over 120 world class Universities
              </p>
              ...
              <div className="space-y-3">
                {universities.map((uni, i) => (
                  <Card
                    key={i}
                    className="group hover-lift border-border bg-card cursor-pointer"
                  >
                    <CardContent className="p-4 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 flex items-center justify-center text-blue-700 dark:text-blue-300 font-bold text-sm">
                          {uni.logo}
                        </div>
                        <div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        {match.eligible ? (
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 hover:bg-red-100"
                          >
                            Not Eligible
                          </Badge>
                        )}
