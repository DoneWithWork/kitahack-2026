...
export default function AssistantPage() {
  ...
  const getScholarshipName = (id: string) => {
    return (
      scholarships?.find((s) => s.uid === id)?.title || "Unknown Scholarship"
    );
  };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 border-blue-200 dark:border-blue-800 hover-lift animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Generate personalized essay drafts tailored to specific
                scholarships and your profile
              </p>
            </CardContent>
          </Card>
          <Card className="bg-linear-to-br from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950 border-purple-200 dark:border-purple-800 hover-lift animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Practice with AI-generated interview questions and get guidance
                on strong answers
              </p>
            </CardContent>
          </Card>
          <Card className="bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border-green-200 dark:border-green-800 hover-lift animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Get suggestions to improve your essays and applications based on
                specific feedback
              </p>
            </CardContent>
          </Card>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Select a scholarship and let AI help you craft the perfect
              application
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <>
                    ...
                    <div className="bg-muted rounded-lg p-4">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                        <li>
                          Include the complete essay prompt from the scholarship
                        </li>
                        <li>
                          Mention specific achievements or experiences you want
                          to highlight
                        </li>
                        <li>Note any word count requirements</li>
                        <li>
                          Describe the tone you&apos;re aiming for (formal,
                          personal, creative)
                        </li>
                      </ul>
                    </div>
                ...
                {interviewQuestions.length === 0 ? (
                  <>
                    <div className="bg-muted rounded-lg p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        AI will generate common interview questions based on the
                        scholarship&apos;s focus and requirements. You&apos;ll
                        also get guidance on how to structure strong answers
                    ...
                    <Button
                      ...
                      disabled={
                        !selectedScholarship || getQuestionsMutation.isPending
                      }
                      className="w-full h-12"
                    >
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-600 mt-0.5 shrink-0" />
                  <span>
                    Connect your experiences to the scholarship&apos;s mission
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-600 mt-0.5 shrink-0" />
                  <span>
                    Be authentic - let your genuine voice shine through
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-4 w-4 text-green-600 mt-0.5 shrink-0" />
